...
``` text
ผลจากการทดลองจากการรันโปรแกรมเพื่อโชว์ข้อความว่า Hello โดยที่ข้อความติดกัน 
...
```text
ผลจากการทดลองจากการรันโปรแกรมเพื่อโชว์ข้อความ โดยที่ข้อความมีการเว้นบรรทัด
...
```text
Console.Write ต่างจาก Console.WriteLine 
ตรงที่ Console.Write โชว์ข้อความโดยที่ติดกัน ส่วน Console.WriteLine
โชว์ข้อความโดยเว้นบรรทัด 
...
```text
เป็นการแสดงค่าที่ได้กำหนดไว้เพื่อต้องที่จะโชว์ข้อความ
...
```text
สามารถใช้งานได้ถ้าเรากำหนดให้แสดงตามที่เราต้องการ
...
```text
การรับค่าของข้อมูลที่กำหนดไว้ก็คือจำนวนหรือลำดับ
...
```
	output Hello there. I said Hello! Hello???
``` csharp
...
```
	output The value: 500.
``` csharp
8. Console.WriteLine("The value: {0:C}.", 500);
```
	output The value: 500.00
``` csharp
...
![](image/13.PNG)
```text
ผลการรันโปรแกรมแสดงแค่ตัวอักษรตัวแรกที่ได้พิมพ์ไป
```
...
![](image/17.PNG)
```text
	เกิด error ขึ้น ป้องกันโดยใช้เงื่อนไข if…else  try{…} ในการแก้ไข
```
...
| `null` |ไม่ได้ |มีตัวอักษรที่ละเมิดกฏการตั้งชื่อ |
| `_value` |ใช้ได้  |ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ  |
| `First-name`|ไม่ได้ |มีตัวอักษรที่ละเมิดกฏการตั้งชื่อ |
| `Hello!` |ไม่ได้ |มีตัวอักษรที่ละเมิดกฏการตั้งชื่อ |
| `w*h` |ไม่ได้ |มีตัวอักษรที่ละเมิดกฏการตั้งชื่อ  |
| `time` |ไม่ได้ |มีตัวอักษรที่ละเมิดกฏการตั้งชื่อ  |
| `do` |ไม่ได้  |มีตัวอักษรที่ละเมิดกฏการตั้งชื่อ |
| `Do` |ไม่ได้ |มีตัวอักษรที่ละเมิดกฏการตั้งชื่อ |
| `21November`|ใช้ได้  |ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ |
| `ladkrabang`|ใช้ได้ |ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ |
| `Student ID`|ใช้ได้  |ไม่มีตัวอักษรที่ละเมิดกฏการตั้งชื่อ |
